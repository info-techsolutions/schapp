...
$myTitle = 'Editing Teacher - MYSCHOOL APP';
...
<div class="ui container">
  ...
  <body>
 	...
 	<div class="ui main text container">
                        <h3 class="ui header">Update your profile</h3> <h6><?php // echo $username;  ?></h6> 
                        ...
                        <div class="ui equal width form">
                            ...
                            <div class="fields">
                                ...
                                <div class="field">
                                    ...
                                    <input type="hidden" name="person_number" value="<?php echo $username; ?>" placeholder="Admission Number">
