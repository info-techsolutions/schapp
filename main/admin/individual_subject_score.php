...
$myTitle = 'Individual Subject Score - MYSCHOOL APP';
...
<div class="pusher">
            ...
            <div class="ui basic segment">
                <div class="ui main text container">
                    ...
                    <div class="ui equal width form">
                        ...
                        <form id="individual-subject-score" method="post" actionn="../classes/individual_student_report.php">
  ...
  <script src="../assets/js/individual_subject_score.js"></script>
