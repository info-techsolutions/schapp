...
$myTitle = 'Showing Parents - MYSCHOOL APP';
...
if (isset($_GET['delparent'])) {
    ...
    $stmt->execute(array(':person_number' => $_GET['delparent']));

    header('Location: show_parent.php?action=deleted');
    exit();
}
?>
  ...
  <body>
                                ...
                                try {
                                    ...
                                    while ($row = $stmt->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="tiny ui button" href="edit_parent.php?person_number=<?php echo $row['person_number']; ?>"><i class="left edit icon"></i></a>
                                                <a class="tiny ui button red" href="javascript:delparent('<?php echo $row['person_number']; ?>','<?php echo $row['firstname']; ?>')"><i class="left delete icon"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $r++;
    ...
    <script>
        $(document).ready(function () {
            ...
            $.getJSON("../public/get_classes.php", function (return_data) {
        ...
        function delparent(id, firstname)
        {
            if (confirm("Are you sure you want to delete '" + firstname + "'"))
            {
                window.location.href = 'show_parent.php?delparent=' + id;
            }
        }
    </script>
</html>
