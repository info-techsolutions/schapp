                        ...
                        <table id="example" class="ui celled table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                try {
                                    include_once '../inc/config.php';
                                    $r = 1;
                                    $stmt = $db->query('SELECT term_id, name, days_opened FROM z_tb_term ORDER BY term_id ASC');
                                    while ($row = $stmt->fetch()) {
                                        ?>
                                        <tr>
                                            <td><?php echo $r; ?></td>
                                            <td><?php echo $row['name']; ?></td>
                                            <td><?php echo $row['days_opened']; ?></td>
                                            <td>
                            ...
                            <div class="fields">
                                <div class="field">
                                 ...
                                 <div class="field">
                                    ...
                                    <input type="text" name="days_opened" id="days_opened" placeholder="Days_opened">
                                </div>
