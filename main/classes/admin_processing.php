            ...
            if ($handle->uploaded) {
        		...
        		$uid = $db->lastInsertId();
                    ...
                    */
                    ...
                    ?>
                    <span class="flow-text">You have successfully added <?php echo $firstname . ' ' . $lastname ?> as a Admin <a href="show_admin.php" class="ui small primary button" style="color: #ffffff; ">view</a></span>
