            ...
            if ($handle->uploaded) {
                ...
                if ($handle->processed) {
                    ...
                    if ($res) {
                        ...
                        */
                        ?>
                        <span class="flow-text">You have successfully added <?php echo $firstname . ' ' . $lastname ?> as a parent <a href="show_parent.php" class="ui small primary button" style="color: #ffffff; ">view</a></span>
