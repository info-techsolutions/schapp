...
if ($_POST) {
    ...
    $personNumber = $_POST['user_admission'];
    ...
    if (!isset($error)) {
        try {
            ...
            if (!empty($user)) {
                ...
                ?>
                <span class="red flow-text">Error You already added a score for this student.</span>
                <!--<script>
                    window.location.href = "../public/check_student_class.php";
                </script>-->
                ...
                if ($result) {
                    ?>
                    <span class="flow-text">Score successfully added. <a href="../public/view_student_score.php?person_number=<?php echo $personNumber; ?>&subject_id=<?php echo $subjectId; ?>&test_id=<?php echo $testId; ?>" class="ui small green button" style="color: #ffffff;">View Score >></a> | <a href="../public/check_student_class.php" class="ui small primary button" style="color: #ffffff;"> << Back</a></span>
