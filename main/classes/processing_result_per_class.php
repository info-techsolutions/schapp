...
$stmt = $db->query("SELECT z_tb_report.person_number, z_tb_person.firstname, z_tb_person.lastname, z_tb_person.gender, z_tb_person.profile_photo_url as photo,"
...
// echo "********************************************************************************<br/>";
echo "<hr /><br />";
?><img src="../images/<?php if ($profilePicture == NULL) echo 'unknown.jpg'; else echo $profilePicture; ?>" style="width: 100px; height: 100px; float: right;"> <br />
                <?php
