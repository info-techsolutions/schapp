    ...
    */
    ...
    if (!isset($error)) {
        try {
                    ...
                    if ($result){
                    ?>
		<span class="flow-text">You have successfully update <?php echo $firstname . ' ' . $lastname ?> record <a href="edit_profile.php" class="ui small primary button" style="color: #ffffff; ">continue</a></span>
