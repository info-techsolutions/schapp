...
// basic basic validation
    ...
    if (!isset($error)) {
        try {
                    ...
                    if ($result){
                    ?>
<span class="flow-text">You have successfully updated subject <?php echo $name; ?><a href="show_subject.php" class="ui small primary button" style="color: #ffffff; ">continue</a></span>
