        ...
        try {
            ...
            if ($handle->uploaded) {
        		...
        		$uid = $db->lastInsertId();
                    ...
                    ?>
                    <span class="flow-text">You have successfully added <?php echo $firstname . ' ' . $lastname ?> as a teacher <a href="show_teacher.php" class="ui small primary button" style="color: #ffffff; ">view</a></span>
