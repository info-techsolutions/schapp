...
// basic basic validation
    ...
    if (!isset($error)) {
        try {
                    ...
                    if ($result){
                    ?>
<span class="flow-text">You have successfully updated arm <?php echo $name; ?><a href="../arm/show_arm.php" class="ui small primary button" style="color: #ffffff; ">continue</a></span>
