        ...
        try {
            ...
            if ($handle->uploaded) {
        		...
        		$uid = $db->lastInsertId();
                    ...
                    //Let's define teachers as users.So we add them in the users table for future reference
                    ...
                    ?>
                    <span class="flow-text">You have successfully added <?php echo $firstname . ' ' . $lastname ?> as a teacher <a href="../public/show_teacher.php" class="ui small primary button" style="color: #ffffff; ">view</a></span>
