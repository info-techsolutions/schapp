...
//    $samyb = @ereg_replace("%([A-Za-z]+)%", "", $samyb);
    $samyb = str_replace("%([A-Za-z]+)%", "", $samyb);
...
/**
 * Function to generate 7 Digits PIN Code
 * 
 * @name generate_code
 * 
 * @return string generated code
...
/**
     ...
     *
     */
    function display_success2($suc) {
        echo "<script language='javascript'> alert('" . $suc . "'); window.location.assign('http://www.hollamarket.com');</script>";
        exit();
    }
/*****************************************************************************************************/
