        ...
        <div class="pusher">
            <div class="ui basic segment">
                <div class="ui main text container">
                    <h3 class="ui header">View  <?php echo $personNumber; ?> Score</h3><a href="individual_subject_score_view.php" class="ui small primary button" style="color: #ffffff;"> << Back</a></span>
